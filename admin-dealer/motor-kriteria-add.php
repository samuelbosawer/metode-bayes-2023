...
<?php
  ...
  $datas =mysqli_query($conn,"SELECT * FROM kriteria ORDER BY id_kriteria ASC ");
      ...
      <div class="row">
        ...
        <form action="" method="POST">
            <div class="col-6">
                ...
                $idCek =mysqli_query($conn,"SELECT id_kriteria_motor FROM kriteria_motor ORDER BY  RIGHT(id_kriteria_motor,5)  DESC LIMIT 1");
                ...
                {                 
                  ...
                  if($id['id_kriteria_motor'] == null)
                  {
                    ...
                    $idNew =   (int) substr($idTerbaru, 3, 7);
                    ++$idNew;
