    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <a href="pencarian.php" data-aos="fade-up" data-aos-delay="200" class="btn btn-primary p-3 btn-lg fw-bolder mb-5">Mulai Pencarian Bayes <i class="bi bi-search"></i> </a>
          <form action="pencarianmanual.php" method="post">
          <div class="input-group p-0 mb-0" data-aos="fade-up" data-aos-delay="200" >
            <input type="text" required name="kata" data-aos="fade-up" data-aos-delay="200" class="form-control p-0" placeholder="Pencarian" aria-label="Pencarian" aria-describedby="button-addon2">
            <button class="btn btn-success" type="submit" data-aos="fade-up" data-aos-delay="200" name="cari" id="button-addon2">Cari</button>
          </div>
          </form>          
        </div>
      ...
      <form action="pencarianmanual.php" method="post">
        <div class="mb-3 col-md-6 mb-5">
          <div class="input-group mb-3">
            <input type="text" required name="kata" class="form-control p-3" placeholder="Pencarian" aria-label="Pencarian" aria-describedby="button-addon2">
            <button class="btn btn-success p-3" type="submit" name="cari" id="button-addon2">Cari</button>
          </div>
        </div>
      </form>
    </div>
      ...
      <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
        <div class="card">
          ...
          <div class="p-3"> 
            ...
            <h5 class="text-dark">  <?=$data['jenis_motor']?> Rp. <?php if($data['harga'] != null) echo number_format($data['harga'],0,',','.')  ?>  </h5>
            <p class="text-dark"> 
