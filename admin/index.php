...
<?php
   ...
   $pemesanan     = "SELECT * FROM transaksi ";
   $kriteria      = "SELECT * FROM kriteria ";
   $pendaftaran   = "SELECT * FROM pendaftaran WHERE dealer = '' ";
   $dealer   = "SELECT * FROM pendaftaran WHERE dealer = 'HONDA' OR dealer = 'YAMAHA' OR dealer = 'KAWASAKI' ";
   ...
   $dealer   = mysqli_query($conn,$dealer);
