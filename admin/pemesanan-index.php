...
// JOIN tabel3 ON tabel2.id = tabel3.tabel2_id;
   ...
   $datas = mysqli_query($conn,"SELECT * FROM transaksi JOIN motor ON transaksi.id_motor = motor.id_motor JOIN pendaftaran ON pendaftaran.id_pendaftaran = transaksi.id_pendaftaran WHERE motor.class = '$dealer'");
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="pemesanan-index">Transaksi</a></li>
