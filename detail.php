...
$kriteria =mysqli_query($conn,"SELECT * FROM `motor`,`kriteria_motor`,`kriteria` WHERE `motor`.`id_motor` = `kriteria_motor`.`id_motor` AND `motor`.`id_motor` = '$id_motor' AND  `kriteria_motor`.`id_kriteria` = `kriteria`.`id_kriteria` ORDER BY motor.id_motor DESC ");
        ...
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start order-lg-last order-first">
            <?php if($data[0]['gambar'] == null) : ?>
              ...
              <?php else :?>
                <img width="300" src="assets/img/data/<?=$data[0]['gambar']?>" alt="" class="">
            <?php endif?>
            <br>
...
<?php if(($_POST) != null) :?>
        <div class="row mt-5 gy-4 text-dark">
            <div class="container">
              <div class="col-12">
