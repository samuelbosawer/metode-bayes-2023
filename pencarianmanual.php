...
if(isset($_POST['cari']) && isset($_POST))
{
  $kata = $_POST['kata'];
  $hasil = 'Hasil pencarian dari ' . $kata;

  $datas = mysqli_query($conn,"SELECT * FROM motor WHERE jenis_motor LIKE '%$kata%' OR alternatif LIKE  '%$kata%'  OR harga LIKE '%$kata%'  OR class LIKE '%$kata%' ");
}
    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-12 text-center p-5 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h2 data-aos="fade-up">Pencarian Manual </h2>
          <p><?=$hasil?></p>
        </div>
      ...
      <form action="pencarianmanual.php" method="post">
        <div class="mb-3 col-md-6 mb-5">
          <div class="input-group mb-3">
            <input type="text" name="kata" class="form-control p-3" value=<?= $kata?> placeholder="Pencarian" aria-label="Pencarian" aria-describedby="button-addon2">
      ...
      <div class="row gy-4">
        <div class="col-12">
          <div class="alert alert-success text-center" role="alert">
            <h5 class="p-5">Maaf data yang anda cari tidak ditemukan !!</h5>  
          </div>
        </div>
